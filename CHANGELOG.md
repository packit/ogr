...
* GithubProject now fully support all the forking-related methods.
...
* The upstream project now has a CONTRIBUTING.md file. All you contriutions are
  welcome!
